...
export const getImageUrl = (base: string, imageSrc: string, resolution?: Resolution, extension = '.svg'): string =>
  `${base}${imageSrc}${resolution ? `@${resolution}${extension}` : extension}`

export const getSrcSet = (base: string, imageSrc: string, extension = '.svg') => {
    ...
    <Wrapper maxHeight={maxHeight}>
      <picture>
        ...
        <ImageWrapper key="bnb">
            ...
            <img src="images/home/YuklaETH.png" alt="bnb" />
