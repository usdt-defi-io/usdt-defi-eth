...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and USDTd pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and USDTd pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from USDTd pool', data)
  }
