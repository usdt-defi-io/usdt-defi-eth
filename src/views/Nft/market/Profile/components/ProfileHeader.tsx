...
import { EtherScanIcon, Flex, IconButton, Link, Button, useModal } from '@pancakeswap/uikit'
        ...
        <Flex display="inline-flex">
          {accountPath && (
            <StyledIconButton
              ...
              alt={t('View EtherScan for user address')}
            >
              <EtherScanIcon width="20px" color="primary" />
            </StyledIconButton>
          )}
        </Flex>
      )
