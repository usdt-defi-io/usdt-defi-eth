          ...
          <Table>
            <thead>
              <tr>
                ...
                <Th textAlign="left" style={{ cursor: 'pointer' }} onClick={() => handleSort(SORT_FIELD.volumeETH)}>
                  {t('Volume')}
                  {arrow(SORT_FIELD.volumeETH)}
                </Th>
                {!isMobile && (
                  <>
            ...
            <tbody>
              {sortedCollections.map((collection) => {
                const volume = collection.totalVolumeETH
                  ? parseFloat(collection.totalVolumeETH).toLocaleString(undefined, {
