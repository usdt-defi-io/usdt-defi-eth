...
const bnbToWETHSymbol = (sym: string) => (sym === 'ETH' ? 'WETH' : sym)
...
const TradingViewChart = ({
  ...
  const symbol = useMemo(() => {
    ...
    const prefix = 'USDT DeFi:'
    const input = bnbToWETHSymbol(inputCurrency.symbol)
    const output = bnbToWETHSymbol(outputCurrency.symbol)
