...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({
  ...
  const handleWithdrawal = async (convertedStakeAmount: BigNumber) => {
    ...
    // trigger withdrawAll function if the withdrawal will leave 0.000001 USDTd or less
    ...
    if (isWithdrawingAll) {
      try {
        const tx = await callWithGasPrice(dexTokenVaultContract, 'withdrawAll', undefined, callOptions)
