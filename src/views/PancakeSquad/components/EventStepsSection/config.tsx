  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active USDT DeFi Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold USDTd'),
      bodyText: [t('Each NFT costs USDTd to mint. Remember you also need ETH to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://ethswap.usdt-defi.io/swap?outputCurrency=0x93D00A0fBd822F249458C5f973bee6C5248670a9"
            target="_blank"
            width="100%"
          >
            {t('Buy USDTd')}
