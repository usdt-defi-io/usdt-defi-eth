    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active YuklaSwap Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get %symbol%', { symbol: 'YUKLA' })}
            </Heading>
            <Text color="textSubtle" small>
              {t('You’ll spend YUKLA to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
              href="/swap?outputCurrency=0x2f392BBd06428Fd5dea8d7bC845C043040d8e2F8"
      ...
      case 2:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('When the IFO sales are live, you can “commit” your YUKLA to buy the tokens being sold.')} <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent YUKLA tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
