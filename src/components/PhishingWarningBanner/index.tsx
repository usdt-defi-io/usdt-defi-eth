...
const PhishingWarningBanner: React.FC = () => {
  ...
  const warningText = t("please make sure you're visiting https://ethswap.usdt-defi.io - check the URL carefully.")
  const warningTextAsParts = warningText.split(/(https:\/\/swap.usdt-defi.io)/g)
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://ethswap.usdt-defi.io'}
          color={text === 'https://ethswap.usdt-defi.io' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
